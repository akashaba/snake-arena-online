...
class TestUsers:
    ...
    def test_get_user_profile(self, client, reset_db):
    ...
    def test_get_user_profile_nonexistent(self, client, reset_db):
        """Test getting nonexistent user profile"""
        response = client.get("/api/v1/users/nonexistent")
        
        assert response.status_code == 404
    
    def test_get_user_stats(self, client, reset_db):
    ...
    def test_get_user_stats_nonexistent(self, client, reset_db):
        """Test getting stats for nonexistent user"""
        response = client.get("/api/v1/users/nonexistent/stats")
        
        assert response.status_code == 404
    
    def test_user_rank_calculation(self, client, reset_db):
